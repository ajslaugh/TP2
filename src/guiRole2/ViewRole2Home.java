...
public class ViewRole2Home {
	...
	// GUI ARea 2: Invites user to create a post
	...
	//Gui area 3: Shows all posts within database from general
	...
	public static void displayRole2Home(Stage ps, User user) {
		...
		theStage.setTitle("CSE 360 Foundations: Staff Home Page"); // ***MODIFIED***
																   // Role2 Home Page -> Staff Home Page
	...
	private ViewRole2Home() {
		...
		// GUI Area 1
		label_PageTitle.setText("Staff Home Page"); // ***MODIFIED*** Role2 -> Staff
		...
		displayPosts.setOnMouseClicked(event -> {
		    if (event.getClickCount() == 2) {
		        ...
		        if (selected >= 0) {
		            ControllerRole2Home.viewReplies(selected);
		        }
		    }
		});
